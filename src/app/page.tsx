...
export default function Home() {
  ...
  return (
    <div className="w-full relative overflow-hidden flex flex-col items-center">
      ...
      {/* HERO SECTION */}
      <section className="relative w-full flex flex-col items-center justify-center text-center z-10 min-h-[90vh]">
        {/* ENHANCED BACKGROUND IMAGE - FULL WIDTH */}
        <div className="absolute inset-0 z-0 w-full overflow-hidden">
          <Image
            src="/images/Battle-of-Avarayr-1000px.png"
            alt="Historical Christian Battle Background"
            fill
          ...
          {/* Bottom fade to smooth the 'chop' with the banner */}
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-neutral-50 dark:from-neutral-950 to-transparent z-10" />
        </div>

        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-40 pb-20 md:pt-56 md:pb-32 flex flex-col items-center">
          <motion.h2
          ...
          <motion.p
            ...
            className="relative z-10 text-lg md:text-xl text-neutral-800 dark:text-neutral-200 font-serif max-w-2xl mb-12 leading-relaxed drop-shadow-md"
          >
          ...
          >
            <Link
              href="/about"
              className="bg-gradient-to-r from-brand-gold to-[#8b876d] text-white shadow-[0_8px_24px_rgba(96,93,69,0.3)] font-bold px-8 py-3.5 rounded-full border border-white/10 flex items-center gap-2 hover:-translate-y-1 active:scale-95 transition-all duration-300 tracking-wide"
            >
              Join Our Mission <ChevronRight className="w-5 h-5" />
            </Link>
            <Link
              href="/about"
              className="bg-brand-gold text-white border-2 border-brand-gold font-bold px-8 py-3.5 rounded-full flex items-center gap-2 hover:bg-transparent hover:text-brand-gold hover:-translate-y-1 active:scale-95 transition-all duration-300 tracking-wide"
            >
              Explore Ministries <ChevronRight className="w-5 h-5" />
            </Link>
          </motion.div>
        </div>
      </section>
