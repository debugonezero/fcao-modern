        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {products.map((product, index) => {
            ...
            return (
              ...
              >
                <div className="relative h-80 w-full bg-white/5 rounded-xl mb-6 overflow-hidden flex items-center justify-center p-4">
                  <Image 
                ...
                <div className="flex-1 flex flex-col items-start text-left">
                  <div className="flex flex-col items-start mb-6">
                    {hasVariations ? (
                      ...
                      <span className="font-bold text-2xl text-neutral-900 transition-all">{product.price}</span>
                    )}
                  </div>
                  ...
                  <div className="mb-6 flex flex-col items-center">
                    ...
                    <input
                      ...
                      className="w-24 bg-neutral-100 border border-neutral-200 text-neutral-900 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-brand-gold/50 transition-all text-center font-medium"
                    />
                  </div>
