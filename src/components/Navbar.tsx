  ...
  return (
    <>
      <motion.nav 
        ...
        className={`${isOpen ? 'fixed' : 'sticky'} top-0 left-0 right-0 z-50 w-full bg-white/60 backdrop-blur-xl border-b border-white/20 shadow-sm transition-all duration-300`}
      >
      ...
      <motion.div
        ...
        className="fixed inset-0 bg-white/95 backdrop-blur-xl z-[45] lg:hidden flex flex-col pt-24 px-8 overflow-y-auto"
      >
